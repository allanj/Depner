...
/**
 * Defines configuration settings for training and testing the neural-network
 * dependency parser.
 *
 * @see NEReconizer
 *
...
public class NEConfig {
	...
	/**
	 * The path for evaluation script
	 */
	public static final String EVAL_SCRIPT = "eval/conlleval.pl";
	
	/**
	 * The path of the temporary file
	 */
	public static final String EVAL_FILE = "eval/temporary.txt";
	...
	/**
	 * Number of threads to use during training. Also indirectly controls how
	 * mini-batches are partitioned (more threads => more partitions => smaller
	 * partitions).
	 */
	public int trainingThreads = 1;

	/**
	 * Refuse to train on words which have a corpus frequency less than this
	 * number.
	 */
	public int wordCutOff = 1;

	/**
	 * Model weights will be initialized to random values within the range
	 ...
	 * this size will be used to train the classifier on each iteration.
	 */
	public int batchSize = 10000;

	/**
	 * An epsilon value added to the denominator of the AdaGrad expression for
	 * numerical stability
	 */
	...
	/**
	 * Regularization parameter. All weight updates are scaled by this single
	 * parameter.
	 */
	public double regParameter = 1e-8;

	/**
	 * Dropout probability. For each training example we randomly choose some
	 * amount of units to disable in the neural network classifier. This
	 * probability controls the proportion of units "dropped out."
	 */
	...
	/**
	 * Total number of tokens provided as input to the classifier. (Each token
	 * is provided in word embedding form.)
	 */
	// TODO: we can figure this out automatically based on features used. 48 =
	// 18 + 18 +12 = 48
	 ...
	 * evaluation. (The frequency of these evaluations is configurable as well;
	 * see {@link #evalPerIter}.)
	 */
	...
	/**
	 * Update word embeddings when performing gradient descent. Set to false if
	 * you provide embeddings and do not want to finetune.
	 */
	 ...
	 * testing. By default,
	 * {@link edu.stanford.nlp.trees.PennTreebankLanguagePack} will be used.
	 */
	...
	/**
	 * If non-null, when parsing raw text assume sentences have already been
	 * split and are separated by the given delimiter.
	 *
	 ...
	 *
	 * As a command-line option, you should provide the fully qualified class
	 * name of a valid escaper (that is, a class which implements
	...
	public NEConfig(Properties properties) {
	...
	/**
	 * Get the {@link edu.stanford.nlp.international.Language} object
	 * corresponding to the given language string.
	 *
	 * @return A {@link edu.stanford.nlp.international.Language} or {@code null}
