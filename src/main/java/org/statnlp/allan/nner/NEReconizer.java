...
public class NEReconizer  {
  ...
  public void train(String trainFile, String devFile, String modelFile, String embedFile, String preModel) {
    ...
    NEUtil.loadConllFile(trainFile, trainSents, trainTrees, config.unlabeled, config.cPOS);
    NEUtil.printTreeStats("Train", trainTrees);

    List<CoreMap> devSents = new ArrayList<>();
    List<DependencyTree> devTrees = new ArrayList<>();
    if (devFile != null) {
      NEUtil.loadConllFile(devFile, devSents, devTrees, config.unlabeled, config.cPOS);
  ...
  */
  ...
  public double testCoNLL(String testFile, String outFile) {
    ...
    NEUtil.loadConllFile(testFile, testSents, testTrees, config.unlabeled, config.cPOS);
