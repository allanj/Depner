...
import org.statnlp.allan.depner.Example;
 ...
 * @author Jon Gauthier
 */
public class NNERClassifier  {

  /** A logger for this class */
  private static Redwood.RedwoodChannels log = Redwood.channels(NNERClassifier.class);
   ...
   * @param preComputed
   */
  public NNERClassifier(NEConfig config, double[][] E, double[][] W1, double[] b1, double[][] W2, List<Integer> preComputed) {
   ...
   * @param preComputed
   */
  public NNERClassifier(NEConfig config, Dataset dataset, double[][] E, double[][] W1, double[] b1, double[][] W2,
   ...
   * backpropagation.
   *
   * @see NNERClassifier.CostFunction
   */
  public class Cost {
  ...
  public Cost computeCostFunction(int batchSize, double regParameter, double dropOutProb) {
    ...
    List<Example> examples = NEUtil.getRandomSubList(dataset.examples, batchSize);
